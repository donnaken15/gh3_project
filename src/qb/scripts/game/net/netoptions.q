...
default_network_preferences = {
	game_type = { ui_string = "Faceoff" checksum = p2_faceoff }
	num_players = { ui_string = "2 Players" checksum = num_2 value = 2 }
	private_slots = { ui_string = "0 Players" checksum = num_0 value = 0 }
	Ranked = { ui_string = "Player" checksum = Player value = 1 }
	num_observers = { ui_string = "No Observers" checksum = num_1 value = 1 }
	team_mode = { ui_string = "None" checksum = teams_none }
	password = { ui_string = "" }
	level = { ui_string = "Houses" checksum = load_z_houses }
	server_name = { ui_string = "Neversoft" }
	network_id = { ui_string = "Guitar Hero 3" }
