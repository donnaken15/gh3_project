...
particle_options_DEBUG = { show_particle_heap = 0 particle_warning_script = FlexParticleWarning }
...
script Set_Outline_Shader_to_Default
	SetOutlineShaderColor \{ Red = 210 Green = 80 Blue = 0 Alpha = 180 }
	SetOutlineShaderParams \{min = 0.01 Max = 0.06 RATE = 1.0 zscale = 0.001 filldist = 17 BlendMode = 0}
endscript
