GP_StarPower_ButterfliesSwirl01 = {
	Pos = (0.3568880259990692, 34.685157775878906, 0.07137899845838547)
	Angles = (0.0, 0.0, 0.0)
	...
	Attach
	Bone = BONE_PELVIS
	EmitRangeDims = (0.699999988079071, 1.0, 0.699999988079071)
	...
	EmitPeriod = 1.0
	SizeRange = [ (0.10000000149011612, 0.10000000149011612) (0.0, 0.0) ]
	SpeedRange = (0.5, 1.5)
	RotVel = (0.0, 0.0)
	RotVelTimeScale = 0.0
	EmitDelayStart = 0.0
