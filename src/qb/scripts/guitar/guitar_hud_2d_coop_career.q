coop_career_hud_2d_elements = {
	...
	elements = [
		{ parent_container element_id = HUD2D_rock_container pos_type = offscreen_rock_pos create_once }
		{
		...
		}
		{
			...
			full = { texture = HUD_rock_tube_glow_full star_texture = HUD_rock_tube_glow_full_b zoff = 0.2 Alpha = 0 }
			create_once
		}
		{
			parent_container
		...
		}
		{
			...
			full = { texture = HUD_rock_tube_glow_full star_texture = HUD_rock_tube_glow_full_b zoff = 0.2 Alpha = 1 }
			create_once
		}
		{
			parent_container
		...
		{ parent_container element_id = HUD2D_score_container pos_type = offscreen_score_pos create_once }
		{
