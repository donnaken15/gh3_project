loaded_body_heaps = [ heap_musician1 heap_musician2 heap_musician3 heap_musician4 ]
loaded_body_paks = [ None None None None ]
loaded_body_paks_ref_counts = [ 0 0 0 0 ]
loaded_anim_heaps = [ heap_musician1_anim heap_musician2_anim heap_musician3_anim heap_musician4_anim ]
loaded_anim_paks = [ None None None None ]
loaded_anim_paks_ref_counts = [ 0 0 0 0 ]
loaded_instrument_heaps = [ heap_instrument1 heap_instrument2 heap_instrument3 heap_instrument4 ]
loaded_instrument_paks = [ None None None None ]
loaded_instrument_paks_ref_counts = [ 0 0 0 0 ]
...
musician_arrays = {
	Body = { pak_type = musician_body size_func = get_musician_body_size access_func = get_musician_body_struct element = pak }
	Anim = { pak_type = musician_body size_func = get_musician_body_size access_func = get_musician_body_struct element = anims_pak }
	instrument = { pak_type = musician_instrument size_func = get_musician_instrument_size access_func = get_musician_instrument_struct element = pak }
}
