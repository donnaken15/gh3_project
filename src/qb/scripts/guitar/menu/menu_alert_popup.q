...
script create_alert_popup
	...
	CreateScreenElement \{Type = SpriteElement PARENT = ap_popup_container Id = autosave_light_overlay texture = Venue_Overlay Pos = (640.0, 360.0) dims = (1280.0, 720.0) just = [ center center ] z_priority = 1099}
