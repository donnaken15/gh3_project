...
PitchShiftEffect1 = { effect = FastPitchShift name = Guitar1PitchShift pitch = 1.0 MaxChannels = 0 }
PitchShiftEffect2 = { effect = FastPitchShift name = Guitar2PitchShift pitch = 1.0 MaxChannels = 0 }
Player1PracticeEffects = { effect = $PitchShiftSlow1 effect2 = $PitchShiftEffect1 }
PitchShiftSlow1 = {
	effect = PitchShift
...
script UnPauseGH3Sounds
	...
	if ($song_paused = 0)
		...
		UnpauseSoundsByBuss \{ #"0x1CA1FF20" }
