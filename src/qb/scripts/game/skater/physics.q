tilt_default_settings = { MotionBalanceActive = FALSE MotionSteeringActive = FALSE MotionTricksActive = FALSE MotionSensitivity = 6 }
tilt_params = {
	debug_display = 0
	...
	stick_angles_fb = [ 5 40 ]
	stick_angles_lr = [ 2 60 ]
	impulse_angles = [ 2 7 ]
	twist_amount = [ 0.1 0.4 ]
